...
public class CombineActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (mBluetoothAdapter == null) {
            Toast.makeText(CombineActivity.this, "Bluetooth is not available", Toast.LENGTH_LONG).show();
            this.finish();
        }
        ...
        public boolean onMenuItemClick(MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.insecure_connect_scan: {
                    ...
                    Intent serverIntent = new Intent(CombineActivity.this, DeviceListActivity.class);
    ...
    private void setupChat() {
        ...
        mConversationArrayAdapter = new ArrayAdapter<String>(CombineActivity.this, R.layout.combine_message);
        ...
        mChatService = new BluetoothChatService(CombineActivity.this, mHandler);
    ...
    private void sendMessage(String message) {
        ...
        if (mChatService.getState() != BluetoothChatService.STATE_CONNECTED) {
            Toast.makeText(CombineActivity.this, R.string.not_connected, Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private void setStatus(int resId) {
        ...
        if (null == CombineActivity.this) {
            return;
        }
        final ActionBar actionBar = CombineActivity.this.getActionBar();
        if (null == actionBar) {
            return;
        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case Constants.MESSAGE_DEVICE_NAME:
                    ...
                    if (null != CombineActivity.this) {
                        Toast.makeText(CombineActivity.this, "Connected to "
                                + mConnectedDeviceName, Toast.LENGTH_SHORT).show();
                    }
                    break;
                case Constants.MESSAGE_TOAST:
                    if (null != CombineActivity.this) {
                        Toast.makeText(CombineActivity.this, msg.getData().getString(Constants.TOAST),
        ...
        switch (requestCode) {
            ...
            case REQUEST_ENABLE_BT:
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    Toast.makeText(CombineActivity.this, R.string.bt_not_enabled_leaving,
                            Toast.LENGTH_SHORT).show();
